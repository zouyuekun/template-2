...
export default function Home() {
  return (
    <div className="w-full min-h-screen flex items-center justify-center p-4 bg-[url('/bg.webp')] bg-cover bg-center bg-no-repeat">
      <div className="max-w-6xl w-full flex flex-col lg:flex-row items-center  rounded-xl p-8">
        {/* 左半部分内容 */}
